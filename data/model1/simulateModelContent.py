...
def model(time, state, 
    ...
    ddt_B = lam0 * B / (1 + (lam0/lam1*B)**20)**(1/20)*(1 - Btot/(Bmax)) - (k1*P1 + k2*P2 + k3*P3)*B

    # equations for mono resistant bacteria dynamics
    ddt_R1 = lam0 * R1 / (1 + (lam0/lam1*R1)**20)**(1/20)*(1 - Btot/(frac1*Bmax)) - (k2*P2 + k3*P3)*R1
    ddt_R2 = lam0 * R2 / (1 + (lam0/lam1*R2)**20)**(1/20)*(1 - Btot/(frac2*Bmax)) - (k1*P1 + k3*P3)*R2
    ddt_R3 = lam0 * R3 / (1 + (lam0/lam1*R3)**20)**(1/20)*(1 - Btot/(frac3*Bmax)) - (k1*P1 + k2*P2)*R3

    # equations for double resistant bacteria dynamics
    ddt_R12 = lam0 * R12 / (1 + (lam0/lam1*R12)**20)**(1/20)*(1 - Btot/(frac12*Bmax)) - k3*P3*R12
    ddt_R13 = lam0 * R13 / (1 + (lam0/lam1*R13)**20)**(1/20)*(1 - Btot/(frac13*Bmax)) - k2*P2*R13
    ddt_R23 = lam0 * R23 / (1 + (lam0/lam1*R23)**20)**(1/20)*(1 - Btot/(frac23*Bmax)) - k1*P1*R23

    # equations for triple resistant bacteria dynamics
    ddt_R123 = lam0 * R123 / (1 + (lam0/lam1*R123)**20)**(1/20)*(1 - Btot/(frac123*Bmax))

    # equations for infected bacteria
    ddt_I11 = lam0 * I11 / (1 + (lam0/lam1*I11)**20)**(1/20)*(1 - Btot/(Bmax)) + pr1 * k1*P1*S1 - ktr1*I11
    ddt_I21 = lam0 * I21 / (1 + (lam0/lam1*I21)**20)**(1/20)*(1 - Btot/(Bmax)) + pr21 * ktr1*I11 - ktr1*I21
    ddt_I31 = lam0 * I31 / (1 + (lam0/lam1*I31)**20)**(1/20)*(1 - Btot/(Bmax)) + pr21 * ktr1*I21 - ktr1*I31

    ddt_I12 = lam0 * I12 / (1 + (lam0/lam1*I12)**20)**(1/20)*(1 - Btot/(Bmax)) + pr2 * k2*P2*S2 - ktr2*I12
    ddt_I22 = lam0 * I22 / (1 + (lam0/lam1*I22)**20)**(1/20)*(1 - Btot/(Bmax)) + pr22 * ktr2*I12 - ktr2*I22
    ddt_I32 = lam0 * I32 / (1 + (lam0/lam1*I32)**20)**(1/20)*(1 - Btot/(Bmax)) + pr22 * ktr2*I22 - ktr2*I32

    ddt_I13 = lam0 * I13 / (1 + (lam0/lam1*I13)**20)**(1/20)*(1 - Btot/(frac3*Bmax)) + pr3 * k3*P3*S3 - ktr3*I13
    ddt_I23 = lam0 * I23 / (1 + (lam0/lam1*I23)**20)**(1/20)*(1 - Btot/(frac3*Bmax)) + pr23 * ktr3*I13 - ktr3*I23
    ddt_I33 = lam0 * I33 / (1 + (lam0/lam1*I33)**20)**(1/20)*(1 - Btot/(frac3*Bmax)) + pr23 * ktr3*I23 - ktr3*I33
